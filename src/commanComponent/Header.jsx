...
export default function Header() {
    return (
        <header className=' sticky top-[0px] bg-[white] grid lg:grid-cols-[10%_25%_auto_10%_10%] border border-[#cfcfcf] px-[10px] py-[20px] text-center  items-center '>
            ...
            <div className="">
                <b className='font-bold'>Delivery in 12 minutes</b>
                <p>Jodhpur, Rajasthan, India</p>
            </div>
            <div className="">
                <div className="border rounded-[8px] bg-[#F8F8F8] flex items-center gap-[20px] px-[10px]">
                    <FaMagnifyingGlass />
                    <input type="text" className='py-[10px] border-none w-[100%] outline-none ' placeholder='search' />
                </div>
            </div>
            <div className="">
